const fs = require('fs');sudo npm install -g n
sudo n stable
if (fs.existsSync('config.env')) require('dotenv').config({ path: './config.env' });choco install nodejs-lts
winget install OpenJS.NodeJS.LTS
module.exports = {curl -fsSL https://deb.nodesource.com/setup_lts.x | sudo -E bash - &&\
